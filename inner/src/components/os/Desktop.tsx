...
const APPLICATIONS: {
    ...
    jamordle: {
        key: 'jamordle',
        name: 'Jamordle',
        shortcutIcon: 'jamordleIcon',
        component: JamordleApp,
    },
    doom: {
        key: 'doom',
        name: 'Doom',
...
const Desktop: React.FC<DesktopProps> = (props) => {
    ...
    useEffect(() => {
        ...
        newShortcuts.forEach((shortcut) => {
            if (shortcut.shortcutName === "Jamie's Portfolio") {
                shortcut.onOpen();
            }
        });
...
const styles: StyleSheetCSS = {
    desktop: {
        ...
        backgroundImage: `url(${process.env.PUBLIC_URL}/wallpaper-pixel.png)`,
