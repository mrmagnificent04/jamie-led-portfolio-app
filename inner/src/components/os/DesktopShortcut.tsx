...
const styles: StyleSheetCSS = {
    ...
    shortcutText: {
        ...
        paddingRight: 2,
        paddingLeft: 2,
        // keeps labels legible over the bright wallpaper
        textShadow:
            '1px 1px 0 rgba(0,0,0,0.9), -1px 1px 0 rgba(0,0,0,0.9), 1px -1px 0 rgba(0,0,0,0.9), -1px -1px 0 rgba(0,0,0,0.9), 0 0 3px rgba(0,0,0,0.7)',
    },
    iconContainer: {
        cursor: 'pointer',
        paddingBottom: 3,
