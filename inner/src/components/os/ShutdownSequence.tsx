...
const ShutdownSequence: React.FC<ShutdownSequenceProps> = ({
    ...
    Connecting to JLOS08/31:2004.${_F}.${_F}.${_F}
    |
    Established connection to JLOS08/31:2004, attempting data transfer.
    |
    ${_F}
    ...
    |(JLOS08/31:204:60099) [DEP_ANALYTICS_SERVER_ON_AFTER_SETUP_MIDDLEWARE] InvalidFormatting: 'onAnalyticsConversion' option received invalid parameters. Please contact a server administrator to resolve the issue.|
    ${_F}
    |(JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:00]|
    |(JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:01]
    (JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:03]
    (JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:05]
    (JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:08]
    (JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:12]
    (JLOS08/31:204:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:14]
    FATAL ERROR: (JLOS08/31:204:60099) Server became unresponsive and the transfer failed. Unable to shutdown computer. 
    |
