...
const keys: { [key in CameraKey]: CameraKeyframe } = {
    ...
    monitor: {
        position: new THREE.Vector3(207, 1917, 900),
        focalPoint: new THREE.Vector3(207, 1917, 181),
    },
    desk: {
        position: new THREE.Vector3(207, 2500, 5500),
        focalPoint: new THREE.Vector3(207, 800, 0),
    },
    loading: {
...
export class MonitorKeyframe extends CameraKeyframeInstance {
    ...
    update() {
        ...
        this.targetPos.z = this.origin.z + aspect * 500 - additionalZoom;
